...
const abschnitte = [
  ...
  },
  {
    ...
    schritte: [
      ...
      { t: 'Verkäuferstatus in der EU: „Händler“',
      ...
      { t: 'Impressum eintragen',
        b: 'Unter <em>Einstellungen → Info und Ansicht → Abschnitt „Impressum"</em>. Platzhalter in eckigen Klammern ersetzen.',
      ...
      { t: 'Widerrufsbelehrung eintragen',
        b: 'Im <strong>Impressum-Bereich</strong> unter <em>„Füge mehr Infos für Käufer:innen hinzu"</em> — das ist der einzige Ort im Shop, an dem längere Rechtstexte hineinpassen. Die Belehrungspflicht besteht <strong>unabhängig davon</strong>, ob das Widerrufsrecht später erlischt. Fehlt sie, verlängert sich die Frist auf bis zu zwölf Monate und 14 Tage. Das Muster-Widerrufsformular gehört dazu.',
        warnung: 'Nicht unter „AGB-Einstellungen → Rückgaben &amp; Umtausch“ suchen. Dahinter liegt kein Textfeld, sondern ein Formular mit Schaltern (nächster Schritt).',
        hinweisBox: 'Prüfe an einer Testbestellung, ob Etsys Kasse die Zustimmung nach § 356 Abs. 5 BGB überhaupt einholt — also die ausdrückliche Zustimmung zum sofortigen Beginn <em>und</em> die Bestätigung, dass der Käufer dadurch sein Widerrufsrecht verliert. Tut sie es nicht, bleibt das Widerrufsrecht bestehen; eine gegenteilige Klausel wäre dann unwirksam und selbst abmahnfähig.',
        kopieren: [['Widerrufsbelehrung mit Muster-Formular', WIDERRUF]] },
      { t: 'Lieferung, Gewährleistung und Zahlung ergänzen',
        b: 'Dasselbe Freitextfeld, direkt im Anschluss an die Widerrufsbelehrung. Auch für diese drei Angaben hat Etsy kein eigenes Feld — vorvertragliche Informationspflicht besteht trotzdem.',
        kopieren: [
      ...
      { t: 'Reiter „Rückgaben &amp; Umtausch“ — Schalter setzen',
        b: 'Unter <em>Einstellungen → AGB-Einstellungen</em>. Hier gibt es <strong>nichts einzutragen</strong>: Das Formular ist für Pakete gebaut und kennt nur Schalter. <strong>Rückgaben an</strong>, <strong>Umtausch aus</strong>, Zeitrahmen <strong>30 Tage nach der Lieferung</strong>, dann „Speichern und anwenden“.',
        etiketten: ['Rückgaben: an', 'Umtausch: aus', '30 Tage'],
        hinweisBox: 'Rückgaben an, weil das der freiwilligen Erstattungszusage entspricht — großzügiger als das Gesetz ist nie abmahnfähig. Umtausch aus, weil ein Tausch gegen einen anderen Artikel bei einer Datei nicht erfüllbar ist. Der automatisch erscheinende Punkt „Käufer trägt die Rücksendekosten“ läuft bei einem Download ins Leere.',
        warnung: 'Beide Schalter aus wäre der schlechteste Fall: Etsy zeigt dann „Keine Rückgaben oder Umtausch“ auf der Artikelseite — genau die Aussage, die als pauschaler Ausschluss gelesen wird.' },
      { t: 'Reiter „Stornierungen“',
        b: 'Unter <em>Einstellungen → AGB-Einstellungen</em>. Stornierungen sind bei sofort bereitgestellten Dateien praktisch nur vor dem Herunterladen möglich — das Widerrufsrecht bleibt davon unberührt.',
        kopieren: [['Stornierungen', 'Eine Stornierung ist möglich, solange die Datei noch nicht heruntergeladen wurde. Melden Sie sich in diesem Fall bitte über die Nachrichtenfunktion — ich storniere die Bestellung und erstatte den Kaufpreis.\n\nDavon unberührt bleibt Ihr gesetzliches Widerrufsrecht; die vollständige Widerrufsbelehrung finden Sie in den Verkäuferinformationen dieses Shops.']] },
      { t: 'Reiter „Datenschutz“',
        b: 'Ebenfalls unter <em>AGB-Einstellungen</em>.',
        kopieren: [['Datenschutz', 'Für die Abwicklung des Kaufs werden nur die Daten verarbeitet, die Etsy mir zu diesem Zweck bereitstellt — insbesondere Name, Rechnungsanschrift und Bestelldaten. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO. Die Daten werden für die Dauer der gesetzlichen Aufbewahrungsfristen gespeichert und nicht an Dritte weitergegeben.\n\nDas verkaufte Produkt selbst verarbeitet keine Daten: Es läuft ausschließlich lokal im Browser des Käufers und überträgt nichts ins Internet.\n\nVerantwortlich im Sinne der DSGVO: [Vorname Nachname], Anschrift wie im Impressum. Für die Verarbeitung auf der Plattform ist Etsy verantwortlich; es gilt deren Datenschutzerklärung.']],
        hinweisBox: 'Der Reiter <strong>„Feste AGB“</strong> daneben ist schreibgeschützt und enthält Etsys Liefer- und Zollbedingungen. Für einen Shop mit ausschließlich digitalen Downloads ist er gegenstandslos — dort ist nichts einzutragen.' },
