  ...
  },
  {
    ...
    schritte: [
      ...
      { t: 'Widerrufsbelehrung eintragen',
        b: 'Unter <em>Einstellungen → AGB-Einstellungen → Reiter „Rückgaben &amp; Umtausch"</em>. Die Belehrungspflicht besteht <strong>unabhängig davon</strong>, ob das Widerrufsrecht später erlischt. Fehlt sie, verlängert sich die Frist auf bis zu zwölf Monate und 14 Tage. Das Muster-Widerrufsformular gehört dazu.',
      ...
      { t: 'Lieferung, Gewährleistung und Zahlung ergänzen',
        b: 'Diese Angaben haben bei Etsy kein eigenes Feld. Trag sie unter <em>„Füge mehr Infos für Käufer:innen hinzu"</em> ein oder häng sie an den Rückgabetext an.',
        kopieren: [
